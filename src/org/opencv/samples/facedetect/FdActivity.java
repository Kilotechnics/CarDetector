...
public class FdActivity extends Activity implements CvCameraViewListener {
            ...
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    try {
                        ...
                        mHogDetector = new HOGDescriptor();
                     
                	    mHogDetector.setSVMDetector(HOGDescriptor.getDefaultPeopleDetector());
    ...
    public Mat onCameraFrame(Mat inputFrame) {
        ...
        else if (mDetectorType == HOG_DETECTOR) {
        	if (mHogDetector != null)
        		mHogDetector.detectMultiScale(mGray, faces, weights);
